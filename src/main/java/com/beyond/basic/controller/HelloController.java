...
//                                    @RequestParam(value = "file") MultipartFile file
//                                    formdata를 통해 json, file(멀티미디어)을 처리할때 RequestPart 어노테이션을 많이 사용
                                    @RequestPart("hello") Hello hello,
                                    @RequestPart("file") MultipartFile file)
    throws JsonProcessingException {
        System.out.println("hello: " + hello);
//        String으로 받은 뒤 수동으로 객체 변환. -> 이렇게 많이 사용한다.
//        ObjectMapper objectMapper = new ObjectMapper();
...
//    {name:'hongildong', email:'hong@naver.com', scores:{math:60, music:70, english:100}}
    ...
    public String axiosJsonNestedFileView() {
        return "axiosJsonNestedFileView";
    }

    @PostMapping("/axios-nested-json-view")
    @ResponseBody
    public String axiosNestedJsonView(@RequestBody Student student){
